            ...
            <form onSubmit={handlePasswordSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-amber-300 rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 bg-white text-amber-900 placeholder-amber-500"
